...
//                 body: body,
//             },
//             token: customerFCM.FCMKEY, // Use FCM token for Android
//         };
...
const sendNotification = async (customerId, title, body, customData = {}) => {
    try {
        ...
        // Determine platform from the FCM key (dummy example for differentiation)
        const isIOS = customerFCM.FCMKEY.startsWith("ios_"); // Example key prefix check
